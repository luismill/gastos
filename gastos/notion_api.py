...
def export_notion_to_csv(csv_path: str, timeout: int = 15) -> bool:
    ...
    def extract_relation_or_rollup(prop: Dict) -> Optional[str]:
        ...
        if prop_type == "rollup":
            return extract_rollup_value(prop.get("rollup", {}))
    ...
    for record in all_records:
        ...
        row = {
            ...
            "Proyecto / Viaje": extract_relation_or_rollup(
                props.get("Proyecto / Viaje", {})
            ),
